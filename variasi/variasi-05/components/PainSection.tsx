    ...
    <section className="bg-[#f8f9fa] py-20 px-5 text-center">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
          Kami tahu apa yang kamu alami sekarang, karena 90% mahasiswa S1 ngerasain hal yang sama:
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          ...
          <div className="bg-white p-8 md:p-10 rounded-3xl shadow-sm border-t-8 border-[#d93025]">
            ...
            <p className="text-gray-700 leading-relaxed">
              Udah download 50 jurnal tapi cuma jadi "hiasan" di folder laptop. Bahasanya dewa banget, baru baca dua paragraf udah mau meledak rasanya.
            </p>
          </div>
          ...
          <div className="bg-white p-8 md:p-10 rounded-3xl shadow-sm border-t-8 border-[#d93025]">
            ...
            <p className="text-gray-700 leading-relaxed">
              Deadline udah mepet tapi draf skripsi nggak jalan-jalan. Dospem nanya "novelty-nya mana?" tapi kamu sendiri nggak tau dapet celahnya dari mana.
            </p>
          </div>
          ...
          <div className="bg-white p-8 md:p-10 rounded-3xl shadow-sm border-t-8 border-[#d93025]">
            ...
            <p className="text-gray-700 leading-relaxed">
              Mau copy-paste tapi takut Turnitin merah. Mau nulis sendiri tapi bingung cara nyusun kalimat ilmiah yang bener dan akurat.
            </p>
          </div>
        </div>
      </div>
