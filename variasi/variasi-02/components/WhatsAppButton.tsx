...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col items-end gap-1">
      {/* Chat Bubble "Tanya Dulu" */}
      <div className="relative bg-white text-gray-900 text-xs font-semibold px-3 py-2 rounded-2xl shadow-lg whitespace-nowrap mb-1">
        Tanya Dulu
        {/* Chat bubble tail pointing down */}
        <div className="absolute -bottom-1.5 right-5 w-3 h-3 bg-white transform rotate-45"></div>
      </div>
      ...
      <a
        ...
        className="bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
