...
const RegistrationForm: React.FC = () => {
  ...
  return (
    <section id="register" className="py-20 px-4 business-gradient text-white border-t-8 border-orange-500">
        ...
        {submitStatus === 'success' ? (
          ...
          <>
            ...
            <div className="mb-6">
              ...
              {/* Timer */}
              <div className="bg-orange-50 py-3 rounded-lg border border-orange-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 p-4 rounded-lg bg-gray-50 focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition-all"
              ...
              <button
                type="submit"
                disabled={submitStatus === 'submitting'}
                className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-4 rounded-lg text-xl mt-4 shadow-lg hover:shadow-2xl transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center"
              >
